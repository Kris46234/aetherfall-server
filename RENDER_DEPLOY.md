...
This package updates the authoritative Render server to protocol 20. The
matching v225 Netlify package must be deployed immediately afterward.
...
```json
{"service":"Aetherfall authoritative co-op","protocol":20,"tickRate":30,"snapshotRate":20}
```

## Connect the existing game

1. Deploy the matching `NETLIFY_CLIENT` v225 package to Netlify.
